...
parser.add_argument(
    "-f", "--file", default="/home/yuvrajs/Lucky_Gupta/DIRE-main/data/test/test/real/071d8a071fea53b8711cc734644045bea1e80cfc.jpg", type=str, help="path to image file or directory of images"
)
parser.add_argument(
    "-m",
    "--model_path",
    type=str,   
    default="/home/yuvrajs/Lucky_Gupta/DIRE-main/data/exp/ckpt/model_epoch_latest.pth",
)
...
for img_path in tqdm(file_list, dynamic_ncols=True, disable=len(file_list) <= 1):
    ...
    print(f"Prob of being synthetic: {(1-prob):.4f}")
